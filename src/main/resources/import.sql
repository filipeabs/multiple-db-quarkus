...
CREATE SEQUENCE IF NOT EXISTS INFORMACOES_SEQ START WITH 1 INCREMENT BY 1 ;
...
VALUES (NEXTVAL('INFORMACOES_SEQ'), 'INSERT DE TESTE 1', CURRENT_TIMESTAMP());

INSERT INTO MYDB.INFORMACOES (ID, FIELD, TS_STAMP) 
VALUES (NEXTVAL('INFORMACOES_SEQ'), 'INSERT DE TESTE 2', CURRENT_TIMESTAMP());